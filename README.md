...
- **Bouton "+" toujours accessible (Round 15)** : le bouton d'ajout (FAB, orange) restait accroché au bas de la page entière plutôt qu'au bas de l'écran visible — avec beaucoup de camions dans la liste, il fallait faire défiler jusqu'en bas de tout pour l'atteindre. Il reste maintenant fixé au coin bas-droit de l'écran, visible et cliquable à tout instant du scroll.
