...
export const STRINGS = {
  ...
  // Round 26: Admin-only truck-history (audit trail) screen.
  historyTitle:{en:"Truck history",th:"ประวัติการดำเนินการ"},
  historyIntro:{en:"Who did what to which truck, and when — created, started, finished, cancelled, reopened, edited, or deleted.",th:"ใครทำอะไรกับรถบรรทุกคันไหน และเมื่อใด — สร้าง เริ่ม เสร็จสิ้น ยกเลิก เปิดใหม่ แก้ไข หรือลบ"},
  historyNoRows:{en:"Nothing recorded in this date range.",th:"ไม่มีข้อมูลในช่วงวันที่นี้"},
  historyTableMissing:{en:"(History isn't set up on this project yet — ask ISD to run the \"truck_events\" table update in supabase-schema.sql.)",th:"(ยังไม่ได้ตั้งค่าประวัติการดำเนินการสำหรับโปรเจกต์นี้ — แจ้งทีม ISD ให้รันคำสั่งเพิ่มตาราง \"truck_events\" ใน supabase-schema.sql)"},
  histActionCreated:{en:"Created",th:"สร้างใหม่"},
  histActionArrived:{en:"Started unloading",th:"เริ่มขนถ่าย"},
  histActionCompleted:{en:"Finished unloading",th:"เสร็จสิ้นการขนถ่าย"},
  histActionCancelled:{en:"Cancelled start",th:"ยกเลิกการเริ่ม"},
  histActionReopened:{en:"Reopened",th:"เปิดใหม่"},
  ...
  // Round 29: bulk plant/carrier reassignment on the Archive screen.
  archiveSelectAll:{en:"Select all",th:"เลือกทั้งหมด"},
  archiveBulkSelectedCount:{en:"{n} selected",th:"เลือกแล้ว {n} คัน"},
  archiveBulkApplyBtn:{en:"Apply to selected",th:"บันทึกกับรายการที่เลือก"},
  archiveBulkHint:{en:"Only fields you fill in below are changed — leave one blank to leave it as is.",th:"เปลี่ยนเฉพาะช่องที่กรอกด้านล่าง — เว้นว่างไว้เพื่อไม่เปลี่ยนแปลง"},
  archiveBulkNothingToApply:{en:"Fill in a plant and/or carrier to apply.",th:"กรุณากรอกโรงงานและ/หรือผู้ขนส่งก่อนบันทึก"},
  archiveBulkDone:{en:"{n} truck(s) updated.",th:"อัปเดตรถบรรทุก {n} คันแล้ว"},
  archiveBulkFailed:{en:"Could not apply the change.",th:"ไม่สามารถบันทึกการเปลี่ยนแปลงได้"},
  // Round 29: a truck already unloading/finished with no photo attached yet.
  photoMissingBadge:{en:"📷 No photo",th:"📷 ไม่มีรูป"},
  photoMissingHint:{en:"This truck has been unloaded but no photo was attached yet.",th:"รถบรรทุกคันนี้ขนถ่ายแล้วแต่ยังไม่มีการแนบรูปภาพ"},
